namespace RetroGamesGo.Droid.ArCore.Renderers
{
    ...
    /// <summary>
    /// Renders a plane, taken from the HelloAR
    /// </summary>   
    public class PlaneRenderer
    {
        ...
        private const int BYTES_PER_SHORT = Java.Lang.Short.Size / 8;
        ...
        public void DrawPlanes(IEnumerable<Plane> allPlanes, Pose cameraPose, float[] cameraPerspective)
        {
            ...
            foreach (var sortedPlane in sortedPlanes)
            {
                ...
                var colorIndex = 0; //planeIndex % PLANE_COLORS_RGBA.Length;
                ...
                var angleRadians = 0;
                var uScale = DOTS_PER_METER;
                var vScale = DOTS_PER_METER * EQUILATERAL_TRIANGLE_SCALE;
    ...
    /// <summary>
    /// A plane that can be sorted by distance   
    /// </summary>   
