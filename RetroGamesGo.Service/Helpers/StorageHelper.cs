namespace RetroGamesGo.Service.Helpers
{
    ...
    public class StorageHelper
    {
        ...
        public StorageHelper(IConfigurationRoot configurion)
        {
            this.connectionString = configurion.GetConnectionString("StorageConnectionString");
        }

        #endregion

        #region --- GetTableReferenceAsync ---
        ...
        /// </summary>
        public async Task AddUpdateItemsAsync<EntityType>(string storageTable, IEnumerable<EntityType> entities)
            where EntityType : TableEntity, new()
        {
